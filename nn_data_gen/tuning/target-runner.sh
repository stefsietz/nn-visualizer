...
###############################################################################
EXE="/home/stefan/anaconda3/envs/tf-pose/bin/python"
FIXED_PARAMS=" /home/stefan/UNI/Mustererkennung/ue5/cifar10/ex3.py -i 1 -e 10"
...
STDOUT=c${CONFIG_ID}.stdout
STDERR=c${CONFIG_ID}.stderr
